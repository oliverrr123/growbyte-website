        ...
        <div className="bg-black min-h-screen">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-0 sm:pb-0 pt-8 sm:pt-16">
                ...
                <div className="mb-16 sm:mb-32 text-center">
                    <h1 className="text-3xl sm:text-5xl font-medium text-white mb-4">CASE STUDIES</h1>
                ...
                <section className="space-y-20 sm:space-y-28 text-white">
                    <div className="flex flex-col md:flex-row md:items-start md:gap-12">
                        ...
                        <div className="flex-1 flex flex-col gap-6 items-start">
                            ...
                            <button className="bg-transparent border border-white border-[0.5px] px-4 py-2 inline hover:bg-white hover:text-black transition-colors duration-300 cursor-pointer">
                                <p>EXPLORE &nbsp;&nbsp;→</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col-reverse md:flex-row md:items-start gap-0 md:gap-12">
                        <div className="flex-1 flex flex-col gap-6 items-start">
                            ...
                            <button className="bg-transparent border border-white px-4 py-2 inline hover:bg-white hover:text-black transition-colors duration-300 cursor-pointer">
                                <p>EXPLORE &nbsp;&nbsp;→</p>
                            </button>
                        </div>
                        <div className="flex-1 w-full md:w-96 flex items-center justify-center">
