...
export const DICTIONARIES: Record<Locale, Dictionary> = {
  en: {
    ...
    pageDescription:
      "How GrowByte builds AI products that make real businesses more money. Read our case studies.",
    listHeading: "CASE  \u00a0STUDIES",
    exploreCta: "EXPLORE \u00a0\u00a0→",
    back: "<\u00a0 Back to solutions & case studies",
    writtenByHuman: "Written by human:",
    founderCeoOf: "Founder & CEO of",
    contactFooterTitle: "Want to see more case studies?\nContact me through the links below:",
  ...
  cs: {
    ...
    back: "<\u00a0 Zpět na řešení a případové studie",
  ...
  sk: {
    ...
    back: "<\u00a0 Späť na riešenia a prípadové štúdie",
