...
export default function Home() {
  ...
  return (
    <div className="bg-white min-h-screenp p-4">
      <div className="sm:px-[10vw] md:px-[20vw] lg:px-[30vw] xl:px-[30vw] 2xl:px-[35vw]">
        ...
        <footer>
          <div className="flex justify-center gap-4 pt-16">
            ...
            <a href="tel:+420776781248" target="_blank" aria-label="Phone"><Image src="/icons/phone.svg" alt="Phone" className="w-8 h-8 hover:opacity-100 transition-opacity" width={32} height={32} /></a>
          </div>
